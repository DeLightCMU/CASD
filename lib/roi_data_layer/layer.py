...
from roi_data_layer.augmentations import SSDAugmentation
import numpy as np
import time
...
class RoIDataLayer(object):
  ...
  def _get_next_minibatch(self, iter=None):
    ...
    return get_minibatch(minibatch_db, self._num_classes, self._ssdaugmentation, iter)
